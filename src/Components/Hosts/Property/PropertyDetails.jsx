...
const PropertyDetails = () => {
  ...
  useEffect(() => {
    const fetchProperty = async () => {
      try {
        const response = await axios.get(`api.guryohub.com/hosts/properties/${id}/`);
  ...
  useEffect(() => {
    const fetchPropertyImages = async () => {
      try {
        const response = await axios.get(`api.guryohub.com/hosts/property-images/?property_id=${id}`);
